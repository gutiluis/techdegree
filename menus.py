...
def upcoming_birthdays_menu(people_list):
    print("\n======== UPCOMING BIRTHDAYS ========")
# passes into the upcoming bdays function in the functions file, days: 90
    functions.upcoming_birthdays(people_list, 90)
    print("====================================\n")
    back_to_main_menu()

# take the list of people from the CSV
...
def age_difference_menu(people_list):
    ...
    while running:
        utils.list_people(people_list)
        try:
            # ask the user to select 2 people to compare birthday
            ...
            # functions file. display_age is a function
            # Display the age of selected people
            functions.display_age(people[0])
            functions.display_age(people[1])
            # pass peoples data into the display age difference function
            # display age in the functions file
